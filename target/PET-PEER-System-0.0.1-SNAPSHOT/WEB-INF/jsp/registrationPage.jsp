...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="nav navbar-navnavbar-right" id="navbarSupportedContent">
		...
		<li class="nav-item active"><a class="nav-link"
			href=<c:url value='/saveUser'/>">Login <span class="sr-only">(current)</span></a></li>
	</div>
</nav>
...
<body>
	...
	<form:form action="${userAction }" method="post"
		modelAttribute="userForm">
		<table>
			<tr>
				<td>Name:</td>
				<td><form:input type="text" path="userName" size="20"
						maxlength="20" autocomplete="on" /><font color="red"><form:errors path="name"/></font></td>
			</tr>
			<tr>
				<td>Password:</td>
