...
<body>
	...
	<form:form action="${userAction }" method="get" modelAttribute="userForm" name="form" onSubmit="matchpassword()">
		<table>
			<tr>
				<td>Name:</td>
				<td><form:input type="text" path="userName" id="name" autocomplete="off"/><font color="red"><form:errors path="userName"/></font></td>
			</tr>
			<tr>
				<td>Password:</td>
			...
			<tr>
				<td><input type="submit" value="Register" onclick='<c:out value="matchpassword()"></c:out>'/></td>
		</table>
	</form:form>
</body>
</html>